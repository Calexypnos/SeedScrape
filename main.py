    ...
    try:
        ...
        <head>
            <style>
                ...
                .column h2 {{ text-align: center; padding:none; margin-top:3px; margin-bottom: 5px; }}
                .item {{ display: flex; justify-content: center; margin-bottom: 3px; }}
                .item span {{ font-size: 1em; text-align:center; font-family: 'Arial Rounded MT Bold', 'Helvetica Rounded', Arial, sans-serif; }}
            </style>
        </head>
        <body>
            {weather_html}
